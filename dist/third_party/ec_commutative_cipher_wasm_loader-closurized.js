...
var ecCommutativeCipher = (() => {
    ...
    return (function (ecCommutativeCipher) {
        ...
        var Module = typeof ecCommutativeCipher != 'undefined' ? ecCommutativeCipher : {};
        ...
        var dependenciesFulfilled = null; // overridden to take different actions when all run dependencies
        // are fulfilled
        ...
        function readAsmConstArgs(sigPtr, buf) {
            ...
            while (ch = HEAPU8[sigPtr++]) {
                ...
                buf += (ch != 105 /*i*/) & buf;
                readAsmConstArgsArray.push(ch == 105 /*i*/ ? HEAP32[buf] :
                    HEAPF64[buf++ >> 1]);
                ++buf;
            }
